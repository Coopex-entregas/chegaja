...
assert.match(index,/app-version" content="14\.33\.6"/);
...
assert.match(index,/chegaja-v232-navigation-final\.css\?v=14\.33\.6/);
assert.match(index,/chegaja-v232-navigation-final\.js\?v=14\.33\.6/);
assert.match(index,/recovery=14336/);
...
assert.match(driverCritical,/getCurrentPosition/);
assert.match(driverCritical,/watchPosition/);
assert.match(driverCritical,/clearWatch/);
assert.match(driverCritical,/enableHighAccuracy:true/);
assert.match(driverCritical,/maximumAge:0/);
assert.match(driverCritical,/function mustTrack/);
assert.match(driverCritical,/function ensureGpsWatch/);
assert.match(driverCritical,/ensureGpsWatch\(true\)/);
assert.match(driverCritical,/window\.addEventListener\('focus'/);
assert.match(driverCritical,/visibilitychange/);
assert.match(driverCritical,/GPS reiniciado/);
...
assert.match(driverCritical,/\/api\/app\/map\/location/);
...
assert.match(driverCritical,/function playSound/);
assert.match(driverCritical,/kind==='offer'/);
assert.match(driverCritical,/kind==='online'/);
assert.match(driverCritical,/kind==='offline'/);
assert.match(driverCritical,/kind==='decline'/);
assert.match(driverCritical,/window\.ChegaJaSound=playSound/);
assert.match(driverCritical,/startOfferSound/);
assert.match(driverCriticalCss,/width:106px!important/);
assert.match(driverCriticalCss,/height:106px!important/);
assert.match(driverCriticalCss,/background:#ff7a00!important/);
assert.match(driverCriticalCss,/data-cj232-locked/);
...
assert.match(driverLive,/status IN \('assigned','accepted','to_pickup','at_pickup','picked_up','in_route','problem'\)/);
assert.match(driverLive,/Finalize ou resolva suas entregas ativas antes de ficar offline/);
assert.match(driverLive,/Autorize uma localização precisa para iniciar/);
...
assert.match(sw,/RECOVERY_VERSION='14\.33\.6'/);

console.log('ChegaJá 14.33.7: GPS auto-recuperável em entrega ativa, online protegido e sons operacionais verificados.');
