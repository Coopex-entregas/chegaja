...
assert.match(index,/app-version" content="14\.33\.23"/);
assert.match(index,/chegaja-v217-driver-navigation\.js\?v=14\.33\.23&recovery=143323/);
assert.match(index,/chegaja-v217-driver-navigation\.css\?v=14\.33\.23&recovery=143323/);
...
assert.match(driver,/ChegaJá 14\.33\.23/);
...
console.log('ChegaJá 14.33.23: oferta full-screen única, aceite e rota coleta/entrega validados.');
