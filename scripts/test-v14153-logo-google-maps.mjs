...
assert.match(driverCritical,/maximumAge:1000/);
assert.match(driverCritical,/Autorize a localização do celular para ficar online/);
assert.match(driverCritical,/O pedido do GPS é disparado imediatamente/);
assert.match(driverCritical,/const locationPromise=!assumedOnline\?askLocation\(\):null/);
...
console.log('ChegaJá 14.33.6: GPS imediato e contínuo, online persistente, bloqueio durante entrega e sons operacionais verificados.');
