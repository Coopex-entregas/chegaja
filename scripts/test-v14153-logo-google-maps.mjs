...
assert.match(driverCritical,/maximumAge:15000/);
assert.match(driverCritical,/Autorize a localização do celular para continuar/);
...
assert.doesNotMatch(driverCritical,/watchPosition/);
...
console.log('ChegaJá 14.33.6: INICIAR aguarda autorização GPS, entrega ativa bloqueia offline e botão médio verificados.');
