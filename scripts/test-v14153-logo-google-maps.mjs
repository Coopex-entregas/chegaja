...
assert.match(index,/app-version" content="14\.33\.1"/);
assert.match(index,/vendor\/leaflet\/leaflet\.js/);
assert.match(index,/chegaja-maps-leaflet\.js\?v=14\.33\.1/);
assert.match(index,/chegaja-v201-operational\.css\?v=14\.33\.1/);
assert.match(index,/chegaja-v217-driver-navigation\.js\?v=14\.33\.1/);
...
assert.match(sw,/RECOVERY_VERSION='14\.33\.1'/);

console.log('ChegaJá 14.33.1: aceite manual, alerta, rota azul viva, cronômetro de coleta e layout do mapa verificados.');
