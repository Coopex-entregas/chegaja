...
assert.match(index,/app-version" content="14\.33\.26"/);
assert.match(index,/chegaja-v217-driver-navigation\.js\?v=14\.33\.26&recovery=143326/);
assert.match(index,/chegaja-v217-driver-navigation\.css\?v=14\.33\.26&recovery=143326/);
...
assert.match(driver,/ChegaJá 14\.33\.26/);
