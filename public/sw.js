const CACHE='chegaja-static-14-17-0';
const CORE=[
  ...
  '/chegaja-realtime-safe.css?v=14.17.0','/app.js?v=14.15.9','/chegaja-final.js?v=14.15.9',
  '/chegaja-v144.js?v=14.15.9','/chegaja-v145.js?v=14.15.9','/chegaja-v148.js?v=14.15.9',
  '/chegaja-v149.js?v=14.15.9','/chegaja-realtime-v2.js?v=14.17.0'
];
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith(caches.match(request).then(cached=>{
    const update=fetch(request).then(response=>{if(response.ok)caches.open(CACHE).then(cache=>cache.put(request,response.clone())).catch(()=>{});return response}).catch(()=>cached);
